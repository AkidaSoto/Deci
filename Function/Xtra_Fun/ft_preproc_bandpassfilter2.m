function [filt] = ft_preproc_bandpassfilter2(dat,Fs,Fbp,N,type,dir,instabilityfix,df,wintype,dev,plotfiltresp,usefftfilt,transwidth)
...
switch type
  ...
  case 'firls' % from NUTMEG's implementation
    ...
    f = [0 [1-transwidth]*Fbp(1) Fbp(1) Fbp(2) Fbp(2)*[1+transwidth] Fs/2]/[Fs /2];
