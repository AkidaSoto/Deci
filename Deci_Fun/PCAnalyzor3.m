...
if Deci.Analysis.ERP.do
    ...
    for Lock = 1:length(Deci.Analysis.Locks)
        ...
        dataplaceholder = ft_datashift2(cfg,data);
        ...
        for chan = 1:length(dataplaceholder.label)
            ...
            erp.condinfo = data.condinfo;
            save([Deci.Folder.Analysis filesep 'Volt_Raw' filesep Deci.SubjectList{subject_list} filesep num2str(Deci.Analysis.Locks(Lock)) filesep dataplaceholder.label{chan}],'erp');
        end
        clear erp
    end
end
