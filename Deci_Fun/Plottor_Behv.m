...
for subject_list = 1:length(Deci.SubjectList)
    ...
    switch Deci.Plot.Behv.Source
        case 'PostArt'
            lock1 = CleanDir([Deci.Folder.Analysis filesep 'Freq_TotalPower' filesep Deci.SubjectList{subject_list}]);
            cond1 = CleanDir([Deci.Folder.Analysis filesep 'Freq_TotalPower' filesep Deci.SubjectList{subject_list} filesep lock1{1}]);
            chan1 = CleanDir([Deci.Folder.Analysis filesep 'Freq_TotalPower' filesep Deci.SubjectList{subject_list} filesep lock1{1} filesep cond1{1}]);
            
            load([Deci.Folder.Analysis filesep 'Freq_TotalPower' filesep Deci.SubjectList{subject_list} filesep lock1{1} filesep cond1{1} filesep chan1{1}]);
        case 'Definition'
